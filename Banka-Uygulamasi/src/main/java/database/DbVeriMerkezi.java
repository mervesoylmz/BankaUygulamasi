...
public class DbVeriMerkezi extends DbConnection{
    ...
    protected double elektrikFaturasi, suFaturasi, doalgazFaturasi, internetFaturasi;
    ...
    public double getDoalgazFaturasi() {
        return doalgazFaturasi;
    }

    public void setDoalgazFaturasi(double doalgazFaturasi) {
        this.doalgazFaturasi = doalgazFaturasi;
    }
